...
| `trading/modules/feed_handler.py` | `trading/data/feed_handler.py` |
| `trading/modules/position_manager.py` | `trading/execution/position_manager.py` |
...
| `trading/adapters/paper_account.py` | `trading/execution/paper_account.py` |
