#!/usr/bin/env python3
"""
Backtest for SideWays V2 Strategy.

SideWays V2 is a sideways market strategy that:
- Uses RSI + Bollinger Bands for oversold entries
- Uses Stochastic golden cross entries
- Uses volume breakout entries
- Filters OBV downtrend (key difference from V1)
"""
...
class SideWaysV2Adapter:
    """Adapter to make SideWaysV2Strategy compatible with Backtester."""

    def __init__(self, config: dict = None):
        self.strategy = SideWaysV2Strategy(strategy_config=config)
...
def main():
    ...
    # Print results
    print_summary("SideWays V2", results, metrics, verbose=args.verbose)
