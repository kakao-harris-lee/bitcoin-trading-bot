...
if __name__ == '__main__':
    print("v21 전략: 완벽 타이밍 재현 (Day)")
    print("유전 알고리즘 최적화 파라미터 적용")
    print("\n진입 조건:")
    print("  - RSI < 35")
    print("  - BB Position < 0.189")
    print("  - Volume Ratio > 1.56")
    print("  - Stochastic K < 27")
    print("  - ADX > 38")
    print("\n청산 조건:")
    print("  - (RSI > 62 AND BB > 0.9 AND Stoch > 89)")
