#!/usr/bin/env python3
"""
v-a-07 Backtesting with Bear Market Filter
===========================================
...
class V37ExitManager:
    ...
    def _check_sideways_exit(self, row, prev_row, profit, highest_price, hold_days):
        """Sideways Exit (v07) - v37 원본 (v-a-04와 동일)"""
...
def main():
    ...
    print("="*70)
    print("  v-a-07 Backtesting (Bear Market Filter)")
    print("="*70)
    ...
    # 결과 저장
    output_file = Path(__file__).parent / 'results' / 'backtest_v07_results.json'
