...
from strategy import DynamicKellyStrategy, v02a_strategy_wrapper


def main():
    print("="*70)
    print("v02a 백테스팅: 동적 Kelly Criterion")
    print("="*70)
    ...
    # 전략 인스턴스
    strategy_instance = DynamicKellyStrategy(config, ml_model)
    ...
    results = backtester.run(df, v02a_strategy_wrapper, 
