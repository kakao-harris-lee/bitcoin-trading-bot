...
from strategy import SplitExitStrategy, v02b_strategy_wrapper


def main():
    print("="*70)
    print("v02b 백테스팅: 동적 Kelly + 분할 매도")
    print("="*70)
    ...
    # 전략 인스턴스
    strategy_instance = SplitExitStrategy(config, ml_model)
    ...
    results = backtester.run(df, v02b_strategy_wrapper,
