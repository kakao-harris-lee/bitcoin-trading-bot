...
from strategy import add_indicators, v14_strategy, check_sell_signal
...
def run_backtest():
    ...
    krw = capital
    btc = 0.0
    position = None  # {'entry_price', 'entry_date', 'highest_price', 'signals'}
    trades = []
    ...
    for i in range(len(df)):
        ...
        # 포지션 없을 때 (매수 확인)
            ...
            signal = v14_strategy(df, i, config)
