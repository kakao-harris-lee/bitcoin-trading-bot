#!/usr/bin/env python3
"""
v32_aggressive 2022 Validation Backtesting
"""
...
def load_config():
    with open('config_2022.json', 'r', encoding='utf-8') as f:
        return json.load(f)
...
def run_backtest(config: Dict) -> Dict:
    ...
    print("\n" + "="*70)
    print("v32_aggressive 2022 Validation Backtesting")
    print("="*70)
    ...
    for m60_i in range(len(m60_df)):
        ...
        market_state_log.append({'timestamp': timestamp, 'market_state': market_state})
    ...
    print("\n" + "="*70)
    print("BACKTEST RESULTS - 2022 VALIDATION")
    print("="*70)
    ...
    with open('results_2022.json', 'w', encoding='utf-8') as f:
        json.dump(results, f, indent=2, ensure_ascii=False, default=str)

    print(f"\n결과 저장: results_2022.json")
