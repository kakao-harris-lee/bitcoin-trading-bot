#!/usr/bin/env python3
"""
v32_aggressive 2023 Validation Backtesting
"""
...
def load_config():
    with open('config_2023.json', 'r', encoding='utf-8') as f:
        return json.load(f)
...
def run_backtest(config: Dict) -> Dict:
    ...
    print("\n" + "="*70)
    print("v32_aggressive 2023 Validation Backtesting")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("BACKTEST RESULTS - 2023 VALIDATION")
    print("="*70)
    ...
    with open('results_2023.json', 'w', encoding='utf-8') as f:
        json.dump(results, f, indent=2, ensure_ascii=False, default=str)

    print(f"\n결과 저장: results_2023.json")
