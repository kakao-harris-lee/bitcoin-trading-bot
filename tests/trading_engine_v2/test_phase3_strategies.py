...
# 테스트 대상 모듈
from trading_engine_v2.modules.v35_long_strategy import (
    V35LongStrategy, MarketClassifier, DynamicExitManager
)
from trading_engine_v2.modules.short_v1_strategy import ShortV1Strategy
from trading_engine_v2.modules.risk_manager import RiskManager, RiskState
