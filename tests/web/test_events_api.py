...
class TestMetricsServiceEventMethods:
    ...
    def test_get_entry_events_returns_list(self):
        ...
        assert len(events) == 1
        assert events[0]["strategy"] == "short_v1"
    ...
    def test_get_entry_events_filters_by_strategy(self):
        ...
        events = service.get_entry_events(hours=24, limit=50, strategy="short_v1")
    ...
    def test_get_hwm_timeline_returns_ordered_list(self):
        ...
        timeline = service.get_hwm_timeline(symbol="BTC", strategy="short_v1", hours=24)
...
class TestEventsAPIEndpoints:
    ...
    def test_get_entry_events_with_filters(self, client):
        ...
        with patch('web.app.metrics_service') as mock_service:
            ...
            response = client.get('/api/events/entry?symbol=BTC&strategy=short_v1&hours=12&limit=100', headers=client.auth_header)

            assert response.status_code == 200
            mock_service.get_entry_events.assert_called_once_with(
                hours=12, limit=100, symbol="BTC", strategy="short_v1"
            )
    ...
    def test_get_hwm_timeline_endpoint(self, client):
        ...
        with patch('web.app.metrics_service') as mock_service:
            ...
            response = client.get('/api/events/hwm/BTC/short_v1', headers=client.auth_header)
