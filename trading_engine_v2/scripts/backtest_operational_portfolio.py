...
Run:
  python trading_engine_v2/scripts/backtest_operational_portfolio.py --by-year
"""
...
from trading_engine_v2.scripts.backtest_v2_strategies import RegimeRouterLiveAdapter, ShortV1StrategyAdapter
