...
사용 예:
    .venv/bin/python trading_engine_v2/scripts/recommend_strategy.py --timeframe day --lookback-days 180
"""
...
from trading_engine_v2.scripts.backtest_v2_strategies import (
    V35StrategyAdapter,
