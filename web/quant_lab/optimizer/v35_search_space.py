...
V35_STRATEGY_PARAMS: Dict[str, List[str]] = {
    ...
    "v35_long_v2": ["risk", "sizing", "trailing", "leverage"],
    "tuned_v35_long_v2_growth": [
        "risk", "sizing", "trailing", "take_profit", "regime_thresholds", "leverage"
    ],
    "tuned_v35_long_v2_hold": [
        "risk", "sizing", "trailing", "take_profit", "leverage"
    ],
    "tuned_v35_long_v2_core_overlay": [
        "risk", "sizing", "trailing", "take_profit", "core_overlay", "leverage"
    ],
